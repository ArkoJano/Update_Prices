...
INSERT INTO `product` VALUES ('PR4192','D1183','Makeup','SKU9763','Maybelline New York Super Stay',1,10,88,'Matte ink lip color',438,300,_binary 'maybellinenylip.jpg',37,45),('PR4298','D1183','Beauty appliances','SKU76G2','T3 Featherweight',1,247,5,'Hair dryer with 2 speed settings, 3 heat settings and a 2-year warranty',87,20,_binary 'T3hairdryerwhite.png',925,1123),('PR4394','D1145','Sneakers','SKU8723','Under Armour Micro G running shoes',1,67,12,'Black running shoes with rubber sole & breathable mesh',566,66,_binary 'underarmourblack.jpg',251,305),('PR4467','D1178','Adaptor','SKUGNXW','Poweradd power converter',1,30,701,'2-outlet universal travel adapter',5000,20,_binary 'poweraddconverter.png',112,136),('PR4689','D1145','Jewelery','SKU7263','10k Rose Gold plated white Gold Diamond ring',1,538,83766,'0.75cttw, I-J Color, I2-I3 Clarity',30,4,_binary 'diamondring.png',2015,2445),('PR4769','D1178','Tablet','SKU6789','Kindle Paperwhite',1,140,767,'Tablet with 6\" high-resolution display with builtin light',3987,200,_binary 'kindle.jpg',524,636),('PR4789','D1178','Laptop','SKUB00V','ASUS Chromebook C201',1,270,18,'11.6 inch latop, navy blue',4534,445,_binary 'asuschromebook.png',1011,1227);
...
-- Dump completed on 2021-05-12 21:30:12
=======
CREATE DATABASE  IF NOT EXISTS `mydb` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `mydb`;
-- MySQL dump 10.13  Distrib 8.0.24, for Win64 (x86_64)
...
-- Dump completed on 2021-05-12 21:30:12
>>>>>>> 3e60486256f54a71adebf87a30c60829acaea9b1
